...
export default function BeSearchFormMain() {
  const searchFormMain = (w: any) => {
    // @ts-ignore
  ...
  useEffect(() => {
    searchFormMain(window);
  }, []);

  return (
      <div id="block-search" className="block-search block-search--main">
        <div id="be-search-form-main" className="be-container">
